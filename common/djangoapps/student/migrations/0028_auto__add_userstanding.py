...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('student_userstanding', (
            ...
            ('account_status', self.gf('django.db.models.fields.CharField')(default='account_enabled', max_length=31, blank=True)),
            ('changed_by', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], blank=True)),
            ('standing_last_changed_at', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2013, 10, 9, 0, 0))),
        ))
    ...
    models = {
        ...
        'student.userstanding': {
            ...
            'account_status': ('django.db.models.fields.CharField', [], {'default': "'account_enabled'", 'max_length': '31', 'blank': 'True'}),
            'changed_by': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['auth.User']", 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'standing_last_changed_at': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 10, 9, 0, 0)'}),
